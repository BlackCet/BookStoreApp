      ...
      <div className="navbar">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content dark:bg-white dark:text-black bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
              {navItems}
            </ul>
          </div>
        ...
        <div className="navbar-end space-x-3">
          ...
          <a className="bg-black text-white dark:bg-gray-400 dark:text-black px-8 py-2 rounded-md hover:bg-slate-900 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
        <Login/>
        </div>
      </div>
    </div>
